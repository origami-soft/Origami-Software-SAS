...
class CodesModelsRelation(models.Model):
    ...
    def create(self, vals):
        if not vals.get('company_id') and vals.get('name_model') in MODELS_WITH_COMPANY:
            vals['company_id'] = self.env.company.id
        return super(CodesModelsRelation, self).create(vals)
    ...
    def create(self, vals_list):
        ...
        return super(CodesModelsRelation, self).create(vals_list)
