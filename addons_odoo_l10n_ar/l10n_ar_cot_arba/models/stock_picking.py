...
class StockPicking(models.Model):
    ...
    def action_present_picking_to_arba(
        ...
        for move_line in self.mapped('move_ids').filtered(lambda x: x.quantity):
        ...
        sequence_number = self.env['ir.sequence'].with_company(self.company_id).sudo().next_by_code('arba.cot.file')
